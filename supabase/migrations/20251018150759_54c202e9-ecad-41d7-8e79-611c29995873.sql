-- Corriger le calcul du crédit parrain selon le type de formule
-- Le crédit de 5% doit être calculé UNIQUEMENT sur les formules annuelles (10 mois)
    ...
    IF NOT EXISTS (
      ...
      IF v_referrer_id IS NOT NULL THEN
        ...
        IF v_plan_billing_period = 'annual' THEN
          ...
          END;
        END IF;
        -- Si c'est une formule mensuelle, pas de crédit généré
      END IF;
    END IF;
  END IF;
